...
(function () {
  ...
  function defaultEmbedApiUrl() {
    try {
      if (typeof window !== "undefined" && window.location) {
        ...
        if (h === "sitechat.in" || h === "www.sitechat.in") {
          return "https://sitechat.in";
        }
  ...
  function updateBrandingFooter() {
    ...
    G["style"]["display"] = "block", H && (H["innerHTML"] = "Powered by <strong>SiteChat</strong>", H["href"] = "https://sitechat.ai", 
